  ...
  return (
    <React.Fragment>
      ...
      <Link href="/connect" underline="none">
        <div className="px-2 py-2 text-sm font-bold tracking-normal uppercase transition-colors duration-300 border-2 rounded-sm cursor-pointer sm:tracking-wide md:tracking-widest md:px-4 sm:text-lg md:text-xl text-spotify-green hover:text-black hover:bg-spotify-green border-spotify-green hover:border-black">
